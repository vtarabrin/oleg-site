        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">6 х 10 м. - Тент тарпаулин 120 гр/м2 с люверсами</h4>
              ...
              <p className="main-text-p">
                ...
                Полиэтиленовый, Универсальный, Туристический, Защитный
              </p>
              <p className="main-text-p">• Размер — 6х10</p>
...
export default TentTarpaulin1206x10;
