        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">4 х 8 м. - Тент тарпаулин 120 гр/м2 с люверсами</h4>
              ...
              <p className="main-text-p">• Размер — 4х8</p>
...
export default TentTarpaulin1204x8;
