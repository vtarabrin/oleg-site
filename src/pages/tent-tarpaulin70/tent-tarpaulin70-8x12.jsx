          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">
                8 х 12 м. - Строительный укрывной тент универсальный 70 гр/м2 с люверсами
              </h4>
              ...
              <p className="main-text-p">• Размер — 8х12</p>
...
export default TentTarpaulin708x12;
