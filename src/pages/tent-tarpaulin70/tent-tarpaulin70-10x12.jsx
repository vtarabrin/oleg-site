        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">10 х 12 м. - Строительный укрывной тент универсальный 70 гр/м2 с люверсами</h4>
              ...
              <p className="main-text-p">• Размер — 10х12</p>
...
export default TentTarpaulin7010x12;
