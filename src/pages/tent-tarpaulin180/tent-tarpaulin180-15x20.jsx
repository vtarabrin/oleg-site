...
function TentTarpaulin18015x20() {
  return (
    <div className="main">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">
                15 х 20 м. - Тент тарпаулин 180 гр/м2 с люверсами
              </h4>
              ...
              <p className="main-text-p">• Размер — 15х20</p>
...
export default TentTarpaulin18015x20;
