        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">2 х 3 м. - Тент тарпаулин 180 гр/м2 с люверсами</h4>
              ...
              <p className="main-text-p">• Размер — 2х3</p>
...
export default TentTarpaulin1802x3;
