...
function TentTarpaulin18015x15() {
  return (
    <div className="main">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">
                15 х 15 м. - Тент тарпаулин 180 гр/м2 с люверсами
              </h4>
              ...
              <p className="main-text-p">
                ...
                Полиэтиленовый, Универсальный, Туристический, Защитный, Усиленный
              </p>
              <p className="main-text-p">• Размер — 15х15</p>
...
export default TentTarpaulin18015x15;
