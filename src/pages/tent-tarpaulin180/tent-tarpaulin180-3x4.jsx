        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">3 х 4 м. - Тент тарпаулин 180 гр/м2 с люверсами</h4>
              ...
              <p className="main-text-p">• Размер — 3х4</p>
...
export default TentTarpaulin1803x4;
