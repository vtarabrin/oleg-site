        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">Бетонная плитка для защиты кабеля 600*300*50</h4>
              ...
              <p className="main-text-p">• Вес 1 плитки 20 кг</p>
              <p className="main-text-p">• Толщина плитки 50 мм</p>
              <p className="main-text-p">• Вес 1 поддона с плиткой 1220 кг</p>
