        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">Битум МГО 130/200</h4>
              <p className="zhbi-tittle-main-h3">
                Физико - химические показатели жидкого дорожного битума МГО 130/200{' '}
              </p>
              ...
              <p className="main-text-p">
                • Температура вспышки, определяемая в открытом тигле, °C, <b>не ниже 180</b>
              </p>
              <p className="main-text-p">
...
export default BitumMGO130x200;
