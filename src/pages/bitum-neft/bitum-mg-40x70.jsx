        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              ...
              <p className="main-text-p">• Количество испарившегося разжижителя, %, <b>не менее 8</b></p>
              <p className="main-text-p">
                • Температура размягчения остатка после определения количества испарившегося
                разжижителя, °C, <b>не ниже 28</b>
              </p>
              <p className="main-text-p">
                • Температура вспышки, определяемая в открытом тигле, °C, <b>не ниже 100</b>
              </p>
              <p className="main-text-p">
                • Испытание и сцепление с мрамором или с песком <b>Выдерживает в соответствии с
                контрольным образцом № 2</b>
              </p>
              <br />
