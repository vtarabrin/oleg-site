        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">Битум МГО 70/130</h4>
              <p className="zhbi-tittle-main-h3">
                Физико - химические показатели жидкого дорожного битума МГО 70/130{' '}
              </p>
              ...
              <p className="main-text-p">
                • Температура вспышки, определяемая в открытом тигле, °C, <b>не ниже 160</b>
              </p>
              <p className="main-text-p">
