        ...
        <aside className="aside-right">
          ...
          <div className="product-cart">
            ...
            <div className="product-cart-right">
              <h4 className="zhbi-tittle-main">Полог oxford 420 гр/м2 2.7 х 4.5 м с люверсами</h4>
              <p className="zhbi-tittle-main-h3">Характеристики:</p>
              <p className="main-text-p">• Люверсы по периметру — есть</p>
              <p className="main-text-p">
                • Свойства и сферы применения — На Камаз, На MAN; Volvo, Для кузова самосвала, Укрывной, С люверсами, На контейнер
              </p>
...
export default TentOxford420PU27x45;
